...
public class ProjectProperties {
	...
	private static Properties readFromConfig() {
		InputStream inputStream = ProjectProperties.class.getClassLoader().getResourceAsStream("config_ep02.properties");
	...
	private static Properties readFromMessages() {
		InputStream inputStream = ProjectProperties.class.getClassLoader().getResourceAsStream("messages_ep10.properties");
